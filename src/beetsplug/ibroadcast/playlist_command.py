...
class IBPlaylistCommand(Subcommand, IBroadcastBase):
    def __init__(self, plugin):
        ...
        self.parser.add_option(
            ...
            dest="upload",
            default=False,
            help="push local M3U playlists to iBroadcast only",
        )
        ...
        self.parser.add_option(
            ...
            dest="download",
            default=False,
            help="pull iBroadcast playlists to local M3U only",
        )
        ...
        self.parser.add_option(
            ...
            dest="sync",
            default=False,
            help="bidirectional sync (default if no direction flag)",
        )
        ...
        self.parser.add_option(
            ...
            dest="pretend",
            default=False,
            help="read-only mode: connect and compare, but make no changes",
        )

        super(IBPlaylistCommand, self).__init__(
            parser=self.parser,
            name=common.plg_ns["__PLAYLIST_COMMAND__"],
            aliases=[common.plg_ns["__PLAYLIST_ALIAS__"]]
            if common.plg_ns["__PLAYLIST_ALIAS__"]
            else [],
            help="sync playlists with iBroadcast",
        )
